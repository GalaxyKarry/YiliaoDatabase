/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2022-11-21 11:58:48                          */
/*==============================================================*/
...
alter table Record add constraint FK_address foreign key (AID)
      references Application (AID) on delete restrict on update restrict;
